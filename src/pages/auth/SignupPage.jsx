// ✍️ Signup - FIXED (No @ADMIN confusion)
...
const SignupPage = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    password: '',
    confirmPassword: '',
    address: { city: 'Butwal', area: '', ward: '', street: '', houseNo: '', nearbyPlace: '' }
  });
    ...
    <div className="min-h-screen bg-gradient-to-br from-secondary to-primary py-12 px-4">
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-8">
          <div className="w-20 h-20 bg-white rounded-full flex items-center justify-center text-primary text-4xl font-bold mx-auto mb-4 shadow-xl">S</div>
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="space-y-4">
                <Input label="City" value="Butwal" disabled />
                <div>
                ...
                <Input label="Nearby Famous Place" placeholder="Kanti School" value={formData.address.nearbyPlace} onChange={(e) => handleChange('address.nearbyPlace', e.target.value)} required />
              </div>
            </div>
            ...
            <div className="text-center pt-4">
              <p className="text-gray-600">Already have an account? <Link to="/login" className="text-primary font-semibold hover:underline">Login here</Link></p>
            </div>
          </form>
        </div>
...
export default SignupPage;    if (field.includes('.')) {
      const [parent, child] = field.split('.');
      setFormData({
        ...formData,
